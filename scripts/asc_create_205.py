#!/usr/bin/env python3
"""Create App Store version 2.0.5."""
...
WHATS_NEW = (
    ...
    "- Voz/autoguardado: arreglado el Picker de categoría que a veces se quedaba bloqueado.\n"
    "- Voz: los selectores de categoría/subcategoría siempre se abren.\n"
    "- Modificar nómina ahora actualiza inmediatamente Home y escudos.\n"
    "- Tile de categoría: solo muestra el primer emoji (sin recortes \"...\")."
)
...
print(f"\nDone. v{NEW_VERSION} created. ID: {version_id}")
