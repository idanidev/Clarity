#!/usr/bin/env python3
"""Create App Store version 2.0.3."""
...
WHATS_NEW = (
    "Mejoras y arreglos:\n"
    "- Widget rediseñado: top categorías del mes, presupuesto y últimos gastos en una sola pantalla.\n"
    "- Botón \"+\" interactivo en el widget para añadir gasto sin abrir la app.\n"
    "- Onboarding contextual al entrar por primera vez en Voz, Metas, Filtros y Nóminas.\n"
    "- Subcategorías existentes ahora autocompletan la categoría al añadir un gasto.\n"
    "- Las secciones colapsadas en gastos se mantienen entre sesiones.\n"
    "- Notificación de inactividad calculada desde tu último gasto.\n"
    "- Bugs de fechas y zonas horarias resueltos (gastos del 31 ya no se pierden en abril).\n"
    "- Más rápido al editar categorías y al cargar gráficos."
)
...
print(f"\nDone. v{NEW_VERSION} created in ASC.")
