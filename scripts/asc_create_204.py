#!/usr/bin/env python3
"""Create App Store version 2.0.4."""
...
WHATS_NEW = (
    ...
    "- Voz: ahora detecta tus categorías reales (\"ITV coche\" va a la categoría \"Coche\" si la tienes).\n"
    "- Voz: nunca se autoguarda sin subcategoría si la categoría tiene.\n"
    "- Importar CSV usa tus categorías, no las predeterminadas.\n"
    "- Botón \"Listo\" en el teclado al introducir importes.\n"
    "- Login siempre en modo oscuro (diseño optimizado).\n"
    "- Onboarding adaptado a iPhones pequeños.\n"
    "- Icono de la app en modo claro con el zoom correcto."
)
...
print(f"\nDone. v{NEW_VERSION} created in ASC. ID: {version_id}")
